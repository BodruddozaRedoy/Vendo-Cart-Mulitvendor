...
router.get("/vendor/products", auth_middleware_1.protect, auth_middleware_1.vendor, product_controller_1.getAllProductsByVendor);
router.get("/", product_controller_1.getAllProducts);
// Vendor and Admin routes
router.post('/', auth_middleware_1.protect, auth_middleware_1.vendor, product_controller_1.addProduct);
